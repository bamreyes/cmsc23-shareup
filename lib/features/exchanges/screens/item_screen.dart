...
class _ItemScreenState extends State<ItemScreen> {
  final GlobalKey<ItemDetailsState> _detailsKey = GlobalKey<ItemDetailsState>();

  @override
  Widget build(BuildContext context) {
    final isReadOnly = widget.post.status == PostStatus.reserved ||
    ...
    return DefaultTabController(
      ...
      child: Scaffold(
        appBar: isReadOnly
            ...
            : AppHeader.backWithAction(
                title: 'Item Details',
                onBack: () => context.pop(),
                bottom: tabBar,
                actionLabel: 'Done',
                onAction: () => _detailsKey.currentState?.save(),
              ),
        body: TabBarView(
          children: [
            ItemDetails(key: _detailsKey, post: widget.post),
